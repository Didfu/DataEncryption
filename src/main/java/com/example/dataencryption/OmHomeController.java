...
public class OmHomeController extends HomeController implements Initializable {
    ...
    public void encryptClick0(ActionEvent event){
        ...
        try {
            ...
            try {System.out.println("Cancelled before enc");
                ...
                CFile cFile = new CFile(filename, "encrypted", "om");
    ...
    public void decrpytClick0(ActionEvent event){
        FileChooser fileChooser = new FileChooser();
        fileChooser.setTitle("Select file");
        addExtensionFilters(fileChooser.getExtensionFilters());
        if (LastVisitedDirectory.getInstance().wasVisited()) {
    ...
    void setTableValues(){
        ...
        fileTable.setItems(FileDao.getOmFiles());
